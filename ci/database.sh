mysql -u ubuntu -e "CREATE TABLE problems (
  id int(11) NOT NULL AUTO_INCREMENT,
  user_id int(11) NOT NULL,
  site varchar(50) NOT NULL,
  participant_id varchar(50) NOT NULL,
  problem_type varchar(50) DEFAULT NULL,
  enrollment_site varchar(255) DEFAULT NULL,
  ...
  PRIMARY KEY (id)
) DEFAULT CHARSET=utf8mb4;" circle_test
mysql -u ubuntu -e "CREATE TABLE problem_comments (
  id int(11) NOT NULL AUTO_INCREMENT,
  problem_id int(11) NOT NULL,
  user_id int(11) NOT NULL,
  site varchar(50) NOT NULL,
  staff_nam varchar(255) DEFAULT NULL,
