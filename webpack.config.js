...
Encore
    ...
    .addEntry("admin-notifications", "./web/assets/js/views/AdminNotifications.js")
    .addEntry("admin-missing-measurements", "./web/assets/js/views/AdminMissingMeasurements.js")
    .addEntry("admin-missing-orders", "./web/assets/js/views/AdminMissingOrders.js")
    .addEntry("admin-sites", "./web/assets/js/views/AdminSites.js")
    ...
    .addEntry("biobank-quanum-today", "./web/assets/js/views/BiobankQuanumToday.js")
    .addEntry("biobank-order-recent-modify", "./web/assets/js/views/BiobankOrderRecentModify.js")
    .addEntry("biobank-orders-today", "./web/assets/js/views/BiobankOrdersToday.js")
    .addEntry("biobank-orders-unfinalized", "./web/assets/js/views/BiobankOrdersUnfinalized.js")
    .addEntry("biobank-orders-unlocked", "./web/assets/js/views/BiobankOrdersUnlocked.js")
    ...
    .addEntry("access-group-management", "./web/assets/js/views/AccessGroupManagement.js")
    .addEntry("notice-edit", "./web/assets/js/views/NoticeEdit.js")
    .addEntry("notice", "./web/assets/js/views/Notice.js")
    .addEntry("workqueue-participant", "./web/assets/js/views/WorkqueueParticipant.js")
    .addEntry("program-hpo", "./web/assets/js/views/ProgramHpo.js")
    .addEntry("hpo-access-management", "./web/assets/js/views/HpoAccessManagement.js")
    .addEntry("nph-access-management", "./web/assets/js/views/NphAccessManagement.js")
