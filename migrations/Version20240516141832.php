...
final class Version20240516141832 extends AbstractMigration
{
    ...
    {
        return 'Adds incomplete_samples column to nph_sample_processing_status table to track number of incomplete samples and previous_status column to track the previous status';
    }
