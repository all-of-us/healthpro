...
final class Version20250423202343 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE nph_admin_order_edit_log (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, order_id VARCHAR(100) NOT NULL, original_order_generation_time DATETIME NOT NULL, updated_order_generation_time DATETIME NOT NULL, created_ts DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
