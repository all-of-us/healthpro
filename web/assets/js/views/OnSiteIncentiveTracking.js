$(document).ready(function () {
            ...
            },
            {
                ...
                render: function (type) {
                    ...
                    if (type === "import_amend") {
                        html =
                            '<span class="label label-primary">Imported</span> <span class="label label-warning">Amended</span>';
                    } else if (type === "import") {
    ...
    $("#date_service_filter_apply").on("click", function () {
        if (
            startDateOfServiceSelector.parsley().validate() === true &&
            endDateOfServiceSelector.parsley().validate() === true
        ) {
