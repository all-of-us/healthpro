$(document).ready(function () {
    ...
    if (PMI.isTimeZoneDiff) {
        html = '<div class="alert alert-warning tz-info">Your computer\'s time zone does not appear to match your HealthPro time zone preference. ';
        ...
        html = '<div class="alert alert-info tz-info"><p>It looks like you are in ' + PMI.timeZones[PMI.browserTimeZone] + '.</p>';
