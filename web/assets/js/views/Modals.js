...
window.PmiConfirmModal = Backbone.View.extend({
    ...
    constructor: function (options) {
        if (options.hasOwnProperty("msg") && typeof options.msg === "string") {
            this._msg = options.msg;
        }
        if (options.hasOwnProperty("isHTML") && typeof options.isHTML === "boolean") {
            this._isHTML = options.isHTML;
        }
        if (options.hasOwnProperty("title") && typeof options.title === "string") {
            this._title = options.title;
        }
        if (options.hasOwnProperty("onTrue") && _.isFunction(options.onTrue)) {
            this._onTrue = options.onTrue;
        }
        if (options.hasOwnProperty("onFalse") && _.isFunction(options.onFalse)) {
            this._onFalse = options.onFalse;
        }
        if (options.hasOwnProperty("onClose") && _.isFunction(options.onClose)) {
            this._onClose = options.onClose;
        }
        if (options.hasOwnProperty("btnTextTrue") && typeof options.btnTextTrue === "string") {
            this._btnTextTrue = options.btnTextTrue;
        }
        if (options.hasOwnProperty("btnTextFalse") && typeof options.btnTextFalse === "string") {
            this._btnTextFalse = options.btnTextFalse;
        }
        if (options.hasOwnProperty("dialogClass") && typeof options.dialogClass === "string") {
            this._dialogClass = options.dialogClass;
        }
        if (options.hasOwnProperty("titleClass") && typeof options.titleClass === "string") {
            this._titleClass = options.titleClass;
        }
        if (options.hasOwnProperty("showX") && _.isBoolean(options.showX)) {
            this._showX = options.showX;
        }
        if (options.hasOwnProperty("showOk") && _.isBoolean(options.showOk)) {
    ...
    render: function () {
        ...
        if (this._dialogClass.length > 0) this.$(".modal-dialog").addClass(this._dialogClass);
