...
use App\Repository\BloodPressureSystolicHeightPercentileRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: BloodPressureSystolicHeightPercentileRepository::class)]
class BloodPressureSystolicHeightPercentile
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
