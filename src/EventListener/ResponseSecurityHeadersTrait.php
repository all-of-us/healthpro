...
trait ResponseSecurityHeadersTrait
{
    public function addSecurityHeaders(Response $response)
    {
        ...
        $contentSecurityPolicy = 'default-src'
            ...
            . " frame-ancestors 'self' nihallofus--ibmdev.sandbox.my.salesforce.com nihallofus--ibmdev--c.sandbox.vf.force.com nihallofus--ibmdev.sandbox.lightning.force.com nihallofus--aouqa.sandbox.my.salesforce.com nihallofus--aouqa--c.sandbox.vf.force.com nihallofus--aouqa.sandbox.lightning.force.com nihallofus--aouuat.sandbox.my.salesforce.com nihallofus--aouuat--c.sandbox.vf.force.com nihallofus--aouuat.sandbox.lightning.force.com"; // accomplishes the same as the X-Frame-Options header above
