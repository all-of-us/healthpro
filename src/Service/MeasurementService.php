...
class MeasurementService
{
    ...
    {
        return $this->params->has('feature.blooddonorpm') && $this->params->get('feature.blooddonorpm') && $this->requestStack->getSession()->get('siteType') === 'dv' && ($this->siteService->isDiversionPouchSite() || $this->siteService->isBloodDonorPmSite());
    }
