...
class Log
{
    ...
    public const NPH_ADMIN_ORDER_EDIT_LOG_CREATE = 'NPH_ADMIN_ORDER_EDIT_LOG_CREATE';
    public const PPSC_API_ERROR = 'PPSC_API_ERROR';

    public const PEDIATRIC_ASSENT_CREATED = 'PEDIATRIC_ASSENT_CREATED';
}
